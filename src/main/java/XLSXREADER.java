...
public class XLSXREADER {
    public static void main(String[] args) {
        try {
            ...
            File excel = new File("/Users/akshatjindal/Downloads/abc.xlsx");
            FileInputStream fis = new FileInputStream(excel);
            XSSFWorkbook book = new XSSFWorkbook(fis);
            XSSFSheet sheet = book.getSheetAt(0);
            Integer startingRowNumber = 847;
            Integer endingRowNumber = 848;
            ...
            for (int i = startingRowNumber; i <= endingRowNumber; i++) {
                ...
                while (startColumnNumber < endColumnNumber) {
                    ...
                    String header = "Language." + sheet.getRow(0).getCell(startColumnNumber).getStringCellValue().toUpperCase();
